        ...
        <AuthLayout title="Welcome !" description="Untuk bisa berbelanja kamu bisa login terlebih dahulu.">
            ...
            <form className="flex flex-col gap-4" onSubmit={submit}>
                <div className="grid gap-4">
                    ...
                    <div className="grid gap-1.5">
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink href={route('password.request')} className="ml-auto text-sm font-medium text-indigo-600" tabIndex={5}>
                                    Forgot password?
                                </TextLink>
                            )}
                        </div>
                ...
                <div className="text-center text-sm font-medium text-gray-900">
                    ...
                    <TextLink href={route('register')} tabIndex={5} className="font-medium text-indigo-600">
                        Register
                    </TextLink>
                </div>
            </form>
