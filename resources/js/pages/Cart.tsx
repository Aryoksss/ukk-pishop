                            ...
                            {cartItems.length > 0 ? (
                                cartItems.map((item) => (
                                    <div key={item.product.id} className="flex items-center gap-4 rounded-md bg-white p-4">
                                        ...
                                        />
                                        <img src={item.product.image || 'placeholder.jpg'} alt={item.product.name} className="h-16 w-16 rounded-md" />
                                            ...
                                            <div className="flex flex-col">
                                                <Input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        setCartItems((prev) =>
                                                            prev.map((i) => (i.product.id === item.product.id ? { ...i, quantity: newQuantity } : i)),
                                                        );
                                                    }}
                                                />
                                            </div>
